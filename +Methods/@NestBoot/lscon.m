...
% Bootstrap sampling applied for normalized least squares with cut off
%
% function [estA,Asupport] = BoLSCON(data,bootstraps,zetavec[,net,rawZeta,straps])
%
%   Input Arguments:
%   ================
...
%% Run
if ~exist('tmpzetas','var') %&& strcmpi(regpath,'input')
