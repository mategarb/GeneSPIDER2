 ...
 *
 * $Id: Matrix.h,v 1.1.1.1 2008/10/08 19:30:44 manju Exp $
 */
...
public:
  ...
  void read( Microarray_Set & data, Parameter & p ) throw( std::string );
  void read( std::istream& in, Microarray_Set & data, Parameter & p ) throw(std::string);
